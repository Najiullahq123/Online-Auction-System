...
public class Customer extends Admin {
    ...
    public Customer(){
        customerF = new JFrame("Online Auction System");
        customerF.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        customerF.setContentPane(customer_panel);
        customerF.pack();
        customerF.setLocationRelativeTo(null);
